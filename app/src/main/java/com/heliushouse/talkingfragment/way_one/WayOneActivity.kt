package com.heliushouse.talkingfragment.way_one
...
import com.heliushouse.talkingfragment.way_one.fragments.WayOneFragmentOne
import com.heliushouse.talkingfragment.way_one.fragments.WayOneFragmentTwo
...
class WayOneActivity : AppCompatActivity(), FragmentDataListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        HelperMethods.addFragmentNoBackStackToActivity(supportFragmentManager, WayOneFragmentOne.newInstance(), R.id.container1)
        HelperMethods.addFragmentNoBackStackToActivity(supportFragmentManager, WayOneFragmentTwo.newInstance(), R.id.container2)
    }
